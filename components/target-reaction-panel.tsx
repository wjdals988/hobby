...
export function TargetReactionPanel({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-10 p-6 text-center">
      ...
      {isVisible ? (
        <motion.button
          ...
          className="focus-ring absolute z-20 rounded-full border-4 border-white/90 bg-[radial-gradient(circle_at_30%_30%,#ffffff,#59c3ff_28%,#0f5ac8_100%)] shadow-[0_0_40px_rgba(89,195,255,0.65)]"
          style={{
            left: position.x,
            top: position.y,
            width: targetSize,
